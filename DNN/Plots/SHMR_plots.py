...
TRUE_data = np.genfromtxt('true_halo_mass_test_set25.csv',
                            delimiter=',',
                            names={'True_Values', 'Original_Index'})

PREDICT_data = np.genfromtxt('NN_halo_mass_test_set25.csv',
                                delimiter=',',
                                names=True)

FEATURES_data = np.genfromtxt('features_test_set25.csv',
                                delimiter=',',
                                names=True)
